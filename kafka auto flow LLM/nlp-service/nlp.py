...
try:
    while True:
        ...
        print(f"Received LLM prompt: {decoded_message}")  # Log received message

        processed_message = llm_inference(decoded_message)

        print(f"Sending LLM output: {processed_message}")  # Log message to be sent
